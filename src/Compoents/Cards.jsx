...
const Cards = ({rating, title,price,img}) => {
    return (
        <div>
            <div className=" mt-20 w-full max-w-sm bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                <a href="#">
                    <img className="rounded-base mb-6" src={img} alt="product image" />
                </a>
                <div>
